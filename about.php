...
<div style="background-color:#434343;">
    <div class="container " >
        <div class="row" >
            <div class="card mt-5">
                <div class="card-body">
                    <center><h4>Tentang</h4></center>
                    <br>
	                    <center><p>Sistem Pendukung Keputusan Untuk pemilihan asisten dosen. yang dibuat dengan metode TOPSIS dan dengan Bahasa PHP
	                      </p></center> 
                          <br>
	    <center><h5 >Terimakasih untuk</h5><br></center> 
		<center> <p>Allah Swt Dan juga Bapak Asmunin Selaku Dosen Pengampu Matkul Sistem Pendukung Keputusan Di Prodi Manajemen Informatikan 2020 B <br></center>
    <center>  <br></center>
		<center> Santika Lana Hayati <br></center>
		<center> Tria Suci Cahyani <br></center>
		<center> Himmatuz Zahiroh <br></center>
	  <center> <p>yang telah bekerjasama atas jalannya sistem ini</p></center>
    				<br>
				<center> <h5>kami</h5></center>
				<center> 1. Himmatuz Zahiroh (20051397070)<br></center>
        <center> 2. Santika Lana Hayati (20051397006)<br></center>
				<center> 3. Tria Suci Cahyani (20051397054) </p></center>
    </div>
                </div>
            </div>
        </div>
