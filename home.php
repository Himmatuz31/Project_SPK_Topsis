...
<!-- 
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container" >
			...
			<div class="parallax"><img src="assets/image/BGF.jpeg" alt="bg"></div>
		</div>
		<!-- Jumbotron End -->
		    ...
		    <div class="section-card" style="padding: 36px 0px;background-color: white">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Asisten Dosen Pemrograman Web, yang dimana menggunakan bahasa pemrograman PHP . Dan sistem ini dibuat untuk memenuhi nilai mata kuliah Sistem Pendukung Keputusan </p>
						</div>
			    	<div class="col s6">
